...
public class KochSequence implements LearningSequence {

    public static final String PREFS_KEY_INFIX = "koch";
    ...
    private static List<MorseCode.CharacterList> createKochList() {
        ...
        for (char c : "uresnaptlwi.jz=foy,vg5/q92h38b?47c1d60x-".toCharArray()) {
