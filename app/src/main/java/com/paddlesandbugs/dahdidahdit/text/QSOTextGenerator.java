...
public class QSOTextGenerator extends AbstractTextGenerator {
    ...
    private final CallsignGenerator callsigns = new CallsignGenerator(MainActivity.stopwords);
    ...
    private String tksrprt() {
        return oneOf("tks rprt", "tks fer rprt", "tks fer nice rprt");
    }


    private String qth() {
        return oneOf("london", "paris", "berlin", "tokyo");
    }


    private String opName() {
        return oneOf("anton", "peter", "mike", "carl", "steve", "al");
    }
    ...
    private void setCall(Map<String, String> values, String callname, String call) {
    ...
    private String oneOf(String... choices) {
